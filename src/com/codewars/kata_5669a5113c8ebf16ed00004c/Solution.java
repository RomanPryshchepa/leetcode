package com.codewars.kata_5669a5113c8ebf16ed00004c;
...
public class Solution {
  ...
  public static void main(String[] args) {
    System.out.println(substringTest("Something","Fun")); //Returns false
    System.out.println(substringTest("Something","Home")); //Returns true
  }

  public static boolean substringTest(String str1, String str2) {
    for (int i = 0; i < str1.length() - 1; i++) {
      if (str2.toLowerCase().contains(str1.toLowerCase().subSequence(i, i + 2))) {
        return true;
      }
    }
    return false;
