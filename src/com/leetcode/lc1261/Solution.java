...
public class Solution {
  ...
  public static void main(String[] args) {
    ...
    var findElements = new FindElements(root);
    System.out.println(findElements.find(1));
    System.out.println(findElements.find(2));

    root = new TreeNode(-1, new TreeNode(-1, new TreeNode(-1), new TreeNode(-1)), new TreeNode(-1));
    findElements = new FindElements(root);
    System.out.println(findElements.find(1));
    System.out.println(findElements.find(3));
    System.out.println(findElements.find(5));

    root = new TreeNode(-1, null, new TreeNode(-1, new TreeNode(-1, new TreeNode(-1), null), null));
    findElements = new FindElements(root);
    System.out.println(findElements.find(2));
    System.out.println(findElements.find(3));
