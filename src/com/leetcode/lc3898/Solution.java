...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(solution.findDegrees(new int[][]{{0, 1, 1}, {1, 0, 1}, {1, 1, 0}})));
        System.out.println(Arrays.toString(solution.findDegrees(new int[][]{{0, 1, 0}, {1, 0, 0}, {0, 0, 0}})));
        System.out.println(Arrays.toString(solution.findDegrees(new int[][]{{0}})));
    }
