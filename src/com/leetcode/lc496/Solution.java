...
public class Solution {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(solution.nextGreaterElement2(new int[]{4,1,2}, new int[]{1,3,4,2})));
        System.out.println();

        System.out.println(Arrays.toString(solution.nextGreaterElement(new int[]{2,4}, new int[]{1,2,3,4})));
        System.out.println(Arrays.toString(solution.nextGreaterElement2(new int[]{2,4}, new int[]{1,2,3,4})));
        System.out.println();
        ...
        System.out.println(Arrays.toString(solution.nextGreaterElement2(num1, num2))); // [236,92,122,236,-1]
        System.out.println();
        ...
        System.out.println(Arrays.toString(solution.nextGreaterElement2(num1, num2)));
    }
