...
public class Solution {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(foodRatings.highestRated("fajbervsj")); // yhptazyko
    foodRatings.changeRating("emgqdbo", 3);
    foodRatings.changeRating("jmvfxjohq", 9);
    foodRatings.changeRating("emgqdbo", 14);
    System.out.println(foodRatings.highestRated("fajbervsj")); // ocqmvmwjq
    System.out.println(foodRatings.highestRated("snaxol")); // emgqdbo
  }
